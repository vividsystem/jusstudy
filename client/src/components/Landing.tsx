	...
	return (
		<div className="relative inset-0 min-h-screen min-w-screen flex flex-col items-center justify-start">
			...
			<div className="relative mt-20 2xl:mt-0 min-h-screen flex flex-col justify-start w-4/6 2xl:gap-8 gap-4">
				<h1 className="2xl:text-10xl/tight lg:text-9xl text-6xl font-serif font-bold max-h-fit">Jus'study</h1>
				<p className="2xl:text-7xl lg:text-4xl text-lg font-serif">A Hack Club <span className="font-bold">You Ship, We Ship</span> where students build projects that help with studying, focus, learning, or school life, and earn prizes for shipping real work.</p>
				<ul className="2xl:text-6xl lg:text-2xl text-md list-disc list-inside font-serif my-2 lg:my-10">
				...
				<div className="2xl:text-5xl lg:text-3xl text-xl flex lg:flex-row flex-col gap-4 2xl:gap-12 lg:gap-8 items-center justify-center">
					<a
